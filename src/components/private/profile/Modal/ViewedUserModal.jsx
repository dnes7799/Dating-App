...
export default function ViewedUserModal() {
    const { data: viewedData, isLoading: viewedDataLoading } = useGetViewedQuery({    refetchOnMountOrArgChange: true,
    })

    console.log('view data', viewedData)
