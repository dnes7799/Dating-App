...
export default function LikedUsers({ setUserActionModalOpen }) {

    const theme = useTheme()

    const [displayUsers, setDisplayUsers] = useState(null)

    const { data: likedData, isLoading: likedLoading, isSuccess: likedSuccess } = useGetLikedQuery({
            ...
            <Box sx={{
                ...
                <Box sx={{
                    ...
                    <Box sx={{
                        ...
                        <FavoriteIcon sx={{ color: '#D92626', fontSize: { sm: '1.1rem', lg: '1.2rem' } }} />
